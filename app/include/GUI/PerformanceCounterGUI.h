#pragma once
/**
 * @file PerformanceCounterGUI.h
 * @brief Small ImGui overlay showing OpenGL version and frame time.
 * @details
 * This panel is informational only. It does not feed any value back into the
 * renderer or shaders.
 */

#include <imgui.h>

/** @brief Draws the OpenGL version and FPS counter window. */
